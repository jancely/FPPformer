...
from layers.Embed import DataEmbedding_Fractional, DataEmbedding_inverted
import numpy as np
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
       ...
       # self.enc_embedding = DataEmbedding_inverted(configs.seq_len, configs.d_model, configs.embed, configs.freq, configs.dropout)
        ...
        self.enc_embedding = DataEmbedding_Fractional(configs.seq_len, configs.d_model, configs.order, configs.position, configs.embed, configs.freq, configs.dropout)
        # Encoder
