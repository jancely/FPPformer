...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='FPPformer')

    # Fractional
    parser.add_argument('--position', type=int, default=1, help='position embedding or not')
    parser.add_argument('--order', type=float, default=0., help='fractional order for position embedding')
